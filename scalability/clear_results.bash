...
SCENARIO_FOLDER_PATH="${PROJECT_FOLDER_PATH}/scalability"
...
read -p "Are you sure you want to clear all parsed result files? (y/n): " confirm
if [[ $confirm != [yY] ]]; then
    echo "Operation cancelled."
    exit 1
fi
rm ${SCENARIO_FOLDER_PATH}/statistic-results/*.csv
rm ${SCENARIO_FOLDER_PATH}/statistic-results/*.txt
